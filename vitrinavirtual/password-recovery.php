	...
	<div class="row">
		<div class="col-sm-12 col-md-12 col-lg-12">
			...
			if (mysqli_num_rows($result) > 0) {				
				...
				$subject = "Tu contraseña para ingresar a VitrinaVirtual";
				$body = "Tu contraseña es:" . $row['contrasenia'];
				...
				<p>¡Email enviado! Por favor revise su correo electrónico.</p>
				<p><a class='alert-link' href=login.html>Login</a></p></div>";
			} else {
				echo "Lo sentimos, el email ingresado no está en nuestros registros.";
			}
			?>
		</div>
	</div>
